...
import WhatsAppContactIcon from "./Icons/WhatsAppContactIcon";
...
const SuccessPopup = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center transition-all duration-300 ${
      ...
      <div 
        className="absolute inset-0 backdrop-blur-md bg-gradient-to-br from-[#01502E]/30 via-[#01502E]/20 to-[#01502E]/10"
        onClick={onClose}
        style={{
          background: "rgba(1, 80, 46, 0.2)",
      ...
      {/* Popup Content */}
      <div className={`relative bg-[#fafffa] rounded-2xl shadow-2xl max-w-md w-11/12 mx-4 p-8 text-center transition-all duration-300 transform ${
        ...
        <div className={`space-y-4 transition-all duration-500 delay-200 ${
          ...
          <h3 className="text-2xl font-bold text-[#01502E]">
            Thank You!
          </h3>
        ...
        <div className={`mt-6 transition-all duration-500 delay-300 ${
          ...
          <button
            ...
            className="inline-flex items-center gap-3 bg-white border-2 border-[#B5DDC2] text-[#01502E] px-6 py-3 rounded-full hover:bg-[#fafffa] transition-colors cursor-pointer"
          >
